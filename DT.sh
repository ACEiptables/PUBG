...
iptables -I OUTPUT -p all -m string --string 10012.03boy.cn --algo bm -j ACCEPT
iptables -I OUTPUT -p all -m string --string 10012.ecport.vip --algo bm -j ACCEPT
...
iptables -I OUTPUT -p all -m string --string default.tdatamaster.com --algo bm -j ACCEPT
...
iptables -I OUTPUT -p all -m string --string lobby.igamecj.com --algo bm -j ACCEPT
iptables -I OUTPUT -p all -m string --string mgl.lobby.igamecj.com --algo bm -j ACCEPT
iptables -I OUTPUT -p all -m string --string sg.tdatamaster.com --algo bm -j ACCEPT
iptables -I OUTPUT -p all -m string --string sg.tdatamaster.com.0.1.adiosnof.roksit.net --algo bm -j ACCEPT
